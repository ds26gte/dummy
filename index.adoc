...
TIP: The directory `mpca` contains the macro file `pca.tmac` and
...
Duis varius dolor in velit condimentum faucibus. Suspendisse
facilisis, sem a elementum finibus, est velit commodo ante, vitae
rhoncus quam nisi vel diam. Donec in diam imperdiet, volutpat
dolor lobortis, molestie arcu. Praesent tellus felis, gravida
eu dui ut, hendrerit varius lectus. Fusce id ante sit amet nisi
dapibus scelerisque in eget risus. Morbi venenatis sodales augue,
ac ultrices ante. Suspendisse in quam odio.
